<?php
    // If city is empty then city = Paris 
    $city = !empty($_GET['city']) ? $_GET['city'] : 'Paris';
    // If country is not precised, country will be empty 
...
?>
    ...
    <body>
        <div class="container">
            ...
            <p>Enter a city and a country to see the weather forecast.</p>
            <!-- Form -->
            <form action="weather.php" method="get">
                <input class="city" type="text" value="<?= $city; ?>" name="city">
                <!-- Select a country -->
                <select value="<?= $country; ?>" class="country-input" name="country">
